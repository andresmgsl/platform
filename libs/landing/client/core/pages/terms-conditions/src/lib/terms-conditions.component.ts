	...
	template: `
		...
		<div class="w-full max-w-[650px] bp-conditions-text mb-10">
			...
			<p>
				...
				opinions of HeavyDuty,its agents and/or affiliates. Comments reflect the
				views and opinions of the person who post their views and opinions. To
				the extent permitted by applicable laws, HeavyDuty shall not be liable
			...
			<p>
				...
				the hyperlink compensates the absence of HeavyDuty; and (d) the link is
			...
			<p>
				...
				e-mail to HeavyDuty. Please include your name, your organization name,
			...
			<p>
				No use of HeavyDuty's logo or other artwork will be allowed for linking
			...
			<p>
				...
				or usability of the website, its software or any of its content.
			</p>
			...
			<p>
				...
				their use of the HeavyDuty platform, its software or content. Any
				downloading or uploading of material to the website is done at the
				user’s own risk and the user will be solely responsible for any damage
				to any computer system or loss of data that results from such
				activities.
			</p>
