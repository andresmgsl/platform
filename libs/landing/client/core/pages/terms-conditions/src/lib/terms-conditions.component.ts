...
@Component({
	...
	template: `
		<div>
			...
			<div class="w-full max-w-[650px] bp-conditions-text">
				<p class="text-black font-semibold">Terms and Conditions</p>

				<p>Welcome to Solana Bounty!</p>

				<p>
					These terms and conditions outline the rules and regulations for the
					use of HeavyDuty's Website, located at
					https://university.heavyduty.builders/.
				</p>

				<p>
					By accessing this website we assume you accept these terms and
					conditions. Do not continue to use Solana Bounty if you do not agree
				...
				<p>
					...
					therefore as referring to same. This website is in beta
				</p>
				...
				<p>
					We employ the use of cookies. By accessing Solana Bounty, you agreed
					to use cookies in agreement with the HeavyDuty's Privacy Policy.
				</p>
				...
				<p>
					...
					Solana Bounty for your own personal use subjected to restrictions set
				...
				<ul>
					...
					<li>
						Bounty Reproduce, duplicate or copy material from Solana Bounty
					</li>
				...
				<p>
					...
					HeavyDuty does not filter, edit, publish or review Comments prior to
					their presence on the website. Comments do not reflect the views and
					opinions of HeavyDuty,its agents and/or affiliates. Comments reflect
					the views and opinions of the person who post their views and
					opinions. To the extent permitted by applicable laws, HeavyDuty shall
				...
				<p>
					HeavyDuty reserves the right to monitor all Comments and to remove any
				...
				<p>
					You hereby grant HeavyDuty a non-exclusive license to use, reproduce,
				...
				<p>
					...
					the hyperlink compensates the absence of HeavyDuty; and (d) the link
				...
				<p>
					...
					sending an e-mail to HeavyDuty. Please include your name, your
				...
				<p>
					No use of HeavyDuty's logo or other artwork will be allowed for
				...
				<p>
					Please note that this is a beta version of the Solana Bounty Program
					and Heavy Duty platform which is still undergoing final testing before
					its official release. The platform, its software and all content found
					on it are provided on an “as is” and “as available” basis. HeavyDuty
					does not give any warranties, whether express or implied, as to the
					suitability or usability of the website, its software or any of its
					content.
				</p>

				<p>
					HeavyDuty will not be liable for any loss, whether such loss is
					direct, indirect, special or consequential, suffered by any party as a
					result of their use of the HeavyDuty platform, its software or
...
export class TermsAndConditionsComponent {
	@HostBinding('class') class =
		'flex text-[#e6e6e6] px-4 py-5 sm:px-6 sm:justify-center bp-bg-street-under-one bp-min-h-content';
}
